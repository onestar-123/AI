...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        if amount <= 0:
            messagebox.showerror("입금액은 양수여야 합니다", "다시 입력하세요")
    ...
    def withdraw(self, amount):
        ...
        if amount <= 0:
            messagebox.showerror("출금액은 양수여야 합니다", "다시 입력하세요")
        # TODO: 잔액 부족이면 ValueError 발생
        elif self.balance - amount < 0:
            messagebox.showerror("잔액 부족", "다시 입력하세요")
...
def parse_amount():
    ...
    try:
        ...
        messagebox.showerror("입력 오류 : 정수를 입력하세요", str(e))
        return None
